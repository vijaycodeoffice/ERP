  ...
  <section class="content">
      <div class="container-fluid">
        ...
        @endif 
              ...
              <form action="{{ route('sales.storesalesreturn') }}" method="POST" enctype="multipart/form-data">
            @csrf
			 ...
			 <div class="col-12">
                ...
                <div class="form-row">
                  <div class="form-group col-md-3">
                    <label for="Invoice Numer">Sales Invoice Number</label>
                    <input type="text" name="invoice_no" value="{{$sales[0]->invoice_no}}" class="form-control" id="invoice_no" readonly placeholder="Invoice Number">
                    <input type="hidden" value="{{$sales[0]->id}}" name="sale_id" id="sale_id" class="form-control"   > 
                 
                  </div>

                  <div class="form-group col-md-3">
                    <label for="Return Invoice Number">Sales Return</label>
                  ...
                  <div class="form-group col-md-3">
                    ...
                    <input type="text" value="{{$sales[0]->invoice_date}}"  name="invoice_date" class="form-control" id="invoice_date" readonly placeholder="Invoice date">
               ...
               <span class="glyphicon glyphicon-calendar"></span>
                  ...
                  <input type="text" value="{{$sales[0]->gross_amount}}"  name="net_amount" id="ggg" class="form-control" id="amount" placeholder="Net Amount" readonly>
                ...
                <input type="hidden" value="{{$sales[0]->invoice_no}}"  name="invoice_no" id="invoice_no" class="form-control"  placeholder="Invoice no" readonly>
...
<div class="form-group col-md-4"></div>
<div class="form-group col-md-4"></div>
<div class="form-group col-md-4">Sales Return Amount
<input type="hidden" value="{{$sales[0]->gross_amount}}"  name="net_amount" id="net_amount" class="form-control"  placeholder="Net Amount" readonly>
<input type="text" value="" name="salesreturn" id="salesreturn" class="form-control" readonly autocomplete="off">
</div>
